...
def seed_data():
     ...
     # --- 0. CRÉATION DES TABLES ---
    # Cette ligne lit tous les modèles importés et recrée les tables manquantes dans PostgreSQL
    Base.metadata.create_all(engine)  # <-- AJOUT : Crée les tables si elles n'existent plus
